...
hotkeys_popup.labels["XF86AudioLowerVolume"] = "Fn+F11"
hotkeys_popup.labels["XF86AudioRaiseVolume"] = "Fn+F12"
...
local taglist_buttons = awful.util.table.join(
  awful.button({ }, M.LEFT , function(t) t:view_only() end),
  awful.button({ modkey }, M.LEFT, function(t)
    if client.focus then
      client.focus:move_to_tag(t)
    end
  end),
  awful.button({ }, M.RIGHT, awful.tag.viewtoggle),
  awful.button({ modkey }, M.RIGHT, function(t)
    if client.focus then
      client.focus:toggle_tag(t)
    end
  end),
  awful.button({ }, M.SCROLL_UP, function(t)
    awful.tag.viewnext(t.screen)
  end),
  awful.button({ }, M.SCROLL_DOWN, function(t)
    awful.tag.viewprev(t.screen)
  end)
)

local tasklist_buttons = awful.util.table.join(
  awful.button({ }, M.LEFT, function (c)
  ...
  awful.button({ }, M.RIGHT, client_menu_toggle_fn()),
  awful.button({ }, M.SCROLL_UP, function ()
    awful.client.focus.byidx(1)
  end),
  awful.button({ }, M.SCROLL_DOWN, function ()
    awful.client.focus.byidx(-1)
  end)
)
...
function change_volume(inc)
  local notification_config = {
    title = "Volume",
    position = "bottom_middle",
    margin = beautiful.xresources.apply_dpi(20),
    timeout = 1,
  }
  if inc > 0 then
...
globalkeys = awful.util.table.join(
  ...
  awful.key(
    { modkey }, "`", function () awful.layout.inc(1) end,
    { description = "select next", group = "layout" }
  ),
  awful.key(
    { modkey, "Shift" }, "`", function () awful.layout.inc(-1) end,
  ...
  awful.key(
    { modkey }, "e", function ()
      -- os.execute hangs awesome
      awful.spawn("nemo --no-desktop")
    end
  )
)
...
clientkeys = awful.util.table.join(
  ...
  awful.key(
    { modkey, "Shift" }, "f", awful.client.floating.toggle ,
...
client.connect_signal("request::titlebars", function(c)
  ...
  local buttons = awful.util.table.join(
    awful.button({ }, M.LEFT, function()
      client.focus = c
      c:raise()
      awful.mouse.client.move(c)
    end),
    awful.button({ }, M.RIGHT, function()
      client.focus = c
      c:raise()
